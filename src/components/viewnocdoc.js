...
const fetchData = async (endpoint) => {
  ...
  useEffect(() => {
    ...
    const endpoints = {
      viewNoc: 'https://car-swipe-backend-production.up.railway.app/api/rto/noc/all',
      viewTransferWithHypo: 'https://car-swipe-backend-production.up.railway.app/api/rtotransfer/transferwithloan/all',
      viewTransferWithoutHypo: 'https://car-swipe-backend-production.up.railway.app/api/rtotransferwithouthypo/transferwithoutloan/all',
    };
