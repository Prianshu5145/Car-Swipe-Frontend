...
const DummyTokenForm = () => {
  ...
  const fetchTokenCount = async () => {
    try {
      ...
      const response1 = await fetch('https://car-swipe-backend-production.up.railway.app/api/token/tokens/count');
      const response2 = await fetch('https://car-swipe-backend-production.up.railway.app/api/dummytoken/dummytokens/count');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://car-swipe-backend-production.up.railway.app/api/dummytoken/submit-dummytoken',
        formDataToSend,
        {
          headers: {
