...
doc.text(`2. If the responsibility for loan closure lies with the customer, it is understood that the loan amount for the vehicle has been disbursed either to the customer’s personal bank account or, in certain cases, to a dummy or internal account of the lending institution associated with the vehicle. Therefore, the customer must ensure loan closure within 48 hours of the deal and provide the NOC for the vehicle within 25-30 working days of loan closure. Failure to comply may result in the cancellation of the deal.`,4, 354,{maxWidth:205});
  doc.text(`3. If Car Swipe is responsible for loan closure, it will settle the mentioned amount within 48 hours. Any extra amount must be paid by the customer. However, providing the NOC remains the customer's responsibility, and failure to submit it on time may result in deal cancellation.`,4,374,{maxWidth:205})
  ...
  //  doc.text(`Authorised Signatory`, pageWidth - 40, 413);
   doc.setFontSize(8);
   doc.text(`Note: This is an electronically generated letter and do not require a physical sign or\nstamp from a Car Swipe representative.`, pageWidth - 115, 418);
   doc.setFontSize(12);
  ...
  //  doc.text(`Authorised Signatory`, pageWidth - 40, 303);
   doc.setFontSize(8);
   doc.text(`Note: This is an electronically generated letter and do not require a physical sign or\nstamp from a Car Swipe representative.`, pageWidth - 115, 309);
   ...
   doc.addPage([210, 337]);
    ...
    doc.setFontSize(15);
    doc.setFont('helvetica', 'bold');
    doc.text(`CAR SWIPE SELLER PROTECTION POLICY`, pageWidth - 164, 58);
    ...
    doc.text(`Car Swipe Seller Protection Policy is an exclusive program by Car Swipe to protect customers selling their cars from any unwarranted post-sale situations.This means that until the car's Registration Certificate (RC) is transferred in the name of the new buyer, we will take care of any hassles related to the car.In case there is any unforeseen incident with your car while the transfer is in process, our legal experts will extend full support, and all expenses* related to the same are covered by us. All you have to do is call us or email us at support@carswipe.in.We take full responsibility for safeguarding the interests of our sellers before the ownership of their car is transferred.`,7,94,{maxWidth:200})
    
    doc.setFontSize(12);
    doc.setFont("helvetica", "bold");
    doc.text(`Car Swipe Seller Protection Policy assures to protect you (Registered Owner) from:`,7,138)
    doc.setFontSize(10);
   ...
   doc.text(`3. Challans issued against the vehicle post-delivery of the car to Car Swipe.`,7,159)
   doc.text(`4. Car Swipe will engage a lawyer at its own cost(s) to represent you before and with any judicial/quasi-judicial/law enforcement agencies, wherever required.`,7,166,{maxWidth:205})

   doc.setFontSize(12);
   doc.text(`Terms & Conditions:`,7,185)
   doc.setFontSize(10);
   doc.text(`1. You (Registered owner) should have provided physical delivery of the Vehicle with Car Swipe.`,7,192);
   doc.text(`2. There is no breach of the Terms & Conditions as on the Application Form and all other T&Cs.`,7,199);
   doc.text(`3. The issue/case comes to the knowledge of Car Swipe in appropriate time.`,7,206);
   doc.text(`4. The issue/case is being allowed to be handled exclusively by Car Swipe for and on your behalf.`,7,213);
doc.text(`5. The coverage is applicable from the date and time of physical delivery of the Vehicle with Car Swipe till the RC Ownership is transferred in the name of the end-buyer.`,7,220,{maxWidth:205})
   
doc.setFontSize(12);
doc.text(`The policy will NOT be applicable if :`,7,238);
doc.setFontSize(10);
doc.text(`1. In case of non-submission of any documents or non-fulfillment of requisite formalities required by the government authorities or Car Swipe within 15-20 days of intimation, including but not limited to presence at RTO, valid loan\nNOC from the bank in case of hypothecation removal, etc., Car Swipe shall not be liable for any default or\ndiscrepancy in the documents of whatsoever nature, and the policy will stand void.`,7,245,{maxWidth:205});
...
doc.text(`4. Car Swipe is not aware of any such issue through the  email – support@carswipe.in.`,7,277);
...
doc.setFontSize(8);
doc.text(`Note: This is an electronically generated letter and do not require a physical sign or\nstamp from a Car Swipe representative.`, pageWidth - 115, 324);
...
doc.setFontSize(8);
doc.text(`Note: This is an electronically generated letter.and do not require a physical sign or\nstamp from a Car Swipe representative.`, pageWidth - 115, 282);
// doc.addImage(
//   'https://res.cloudinary.com/dztz5ltuq/image/upload/v1734425018/WhatsApp_Image_2024-12-17_at_14.05.25_785b0425-removebg-preview_f8eoli.png',
//   'PNG',
//   pageWidth - 40,
...
doc.setFontSize(8);
doc.text(`Note: This is an electronically generated letter.and do not require a physical sign or\nstamp from a Car Swipe representative.`, pageWidth - 115, 283);
// doc.addImage(
//   'https://res.cloudinary.com/dztz5ltuq/image/upload/v1734425018/WhatsApp_Image_2024-12-17_at_14.05.25_785b0425-removebg-preview_f8eoli.png',
//   'PNG',
//   pageWidth - 40,
...
doc.text(`1. Car Swipe Services Pvt Ltd. is a  registered company with CIN No. U45102UP2025PTC225693 Under Government of India. The Customer/Authorized Representative (AR) has approached and represented to Car Swipe with an intent to sell his/her vehicle. “Customer” will represent the customer or his/her Authorized Representative in all communications herewith.`,4,75,{ maxWidth: 205 })
   ...
   doc.setFont('helvetica', 'bold');
   doc.text(` 4. The Customer represents to Car Swipe as follows :`,4,130,{maxWidth:205})
   doc.setFont('helvetica', 'NORMAL');
   doc.text(`i. That the Customer is the Registered/Legal owner and/or has valid authorization from the Registered owner of the Vehicle, the details of which have been mentioned on the front page of this Form and is legally competent to sell the Vehicle. In case of an Authorized Representative, the Authorized Representative represents that he/she is fully authorized and competent to act for and on behalf of the Registered owner for the sale of the Vehicle, including entering into the transaction with Car Swipe and hereby indemnifies Car Swipe in case of any contest/falsity to the said extent, if identified or comes to the knowledge of Car Swipe even at a later stage.`,4,135,{maxWidth:205})
   doc.text(`ii. That as on date, there are no violations under applicable laws, including but not limited to any accident involving the Vehicle. The Customer acknowledges and indemnifies Car Swipe for any pending violations or offenses, traffic issues, prior damage due to any accident or natural calamities, or otherwise involving the Vehicle. The Customer acknowledges that any misrepresented facts about the Vehicle or its condition shall make the Customer solely liable to compensate Car Swipe for the same. In case Car Swipe has to incur any cost(s)/loss(es) for any of the aforementioned representations in this paragraph, then the consequences and expenses shall be borne by the Customer, and Car Swipe and/or the future buyer shall not be liable for the same in any manner whatsoever.`,4,158,{maxWidth:205})
   doc.text(`iii. That the Vehicle is free from any kind of encumbrances, including but not limited to any liability such as superdari, theft, arrears of sales tax, value-added tax, road tax, government dues, blacklisting in government records, or similar liabilities as of the date of this agreement. There are no claims, proceedings, notices, disputes, or litigation relating to the operation, use, or ownership of the Vehicle, including but not limited to any claims, proceedings, notices, disputes, or litigation relating to any accident, unpaid dues, or violations of the terms of the insurance obtained for the Vehicle. The Customer understands that if any discrepancies are identified and/or found in the ownership of the Vehicle, then all related costs/expenses to rectify the same shall be borne solely by the Customer, and Car Swipe shall initiate appropriate legal proceedings by taking recourse to all remedies available to it against the Customer.`,4,186,{maxWidth:205})
   doc.text(`iv. That the Vehicle is insured as per requisite statutory and regulatory requirements, the details of which have been mentioned on the front page of this Form. The Customer acknowledges that upon the delivery and/or transfer of ownership of the Vehicle, the Insurance of the Vehicle shall also get transferred, and the Customer shall not make any claim thereof, including but not limited to any No Claim Bonus. The Customer allows Car Swipe and/or any third party identified by Car Swipe all the rights to claim any insurance amount for any period subsequent to the day of delivery of the Vehicle by the Customer to Car Swipe. In case the claim amount is received by the Customer, then the Customer shall be liable to immediately transfer the same and/or make the payment of the said amount in favor of Car Swipe and/or any third party identified by Car Swipe within a period of 7  days upon a simple demand made by Car Swipe in writing at the available address/contact details submitted by the Customer. In case of any default, the Customer shall be solely liable to compensate Car Swipe and/or any third party identified by Car Swipe for any losses and damages arising therefrom. If the Vehicle insurance has expired on or before the date of delivery, then the Customer shall be liable for all/any liability arising out of the same until the Vehicle is insured, and Car Swipe shall not be liable for any liabilities arising therefrom.`,4,219,{maxWidth:205})
   doc.text(`v. That there are no loans, including but not limited to any linked loan, in relation to which any security interest has been created over the vehicle. In the event there are any such loans, the Customer undertakes to obtain a no-objection letter from the relevant bank or financial institution consenting to the sale of the Vehicle by the Customer. Car Swipe shall be entitled to transfer all or part of the purchase consideration payable for the Vehicle directly to the relevant bank or financial institution, and such amount shall be adjusted by Car Swipe against the full and final price of the Vehicle. If such representation is later found to be misleading or untrue, Car Swipe shall initiate appropriate legal proceedings by taking recourse to all remedies available to it against the Customer.`,4,269,{maxWidth:205})
   doc.text(`vi. The Customer acknowledges that Car Swipe is purchasing the vehicle for resale, and the Customer relinquishes all rights to the vehicle after the delivery of the vehicle is taken by Car Swipe. Thereafter, Car Swipe shall possess all rights to further sell the vehicle to any third party for any price.`,4,296,{maxWidth:205})
   doc.text(`vii. The Customer acknowledges that he/she shall be liable for any tax/levy/cess as may be applicable on the transaction with Car Swipe.`,4,309,{maxWidth:205})
   doc.text(`viii. The Customer shall provide all necessary cooperation and assistance as Car Swipe may require for transfer of the registered ownership of the Vehicle to a purchaser of the Vehicle, including personal appearances before government authorities such as the RTO (Party Peshi), executing any papers, applications, written statements, affidavits, deeds, agreements, or documents as Car Swipe may request. The Customer acknowledges that in case the Customer does not perform his obligation under this paragraph, Car Swipe shall not be liable for any liability that may arise on the Customer on account of non-transfer of the RC or otherwise, and Car Swipe shall be entitled to initiate appropriate legal proceedings against the Customer with respect to any inconvenience caused or losses incurred on account of such breach.`,4,315,{maxWidth:205})

   doc.addPage([210, 297]);
   doc.text(`5. The Customer confirms and acknowledges that the Car Swipe offered price, as mentioned in the payment acknowledgment receipt, is the full and final agreed amount for the Vehicle. The Customer agrees that no further claims for a higher price shall be made at any point in the future.`,4,11,{maxWidth:205})
   doc.text(`6. The Customer has submitted and shall submit all statutory documents required for the transfer of ownership of the Vehicle with Car Swipe as and when necessary. The Customer further understands and agrees to cooperate in completing all formalities for the smooth transfer of ownership, which may include visiting the concerned RTO if required and mandated. Any failure on the part of the Customer to fulfill these obligations shall grant Car Swipe the right to claim compensatory damages resulting therefrom.`,4,28,{maxWidth:205})
   doc.text(`7. In case of held-back amount: If Car Swipe has withheld an amount payable to the Customer (referred to as the held-back amount), then upon Car Swipe's satisfaction regarding the clearance of the contingency for which the amount was withheld, Car Swipe shall process the payment of the held-back amount in full or in part. The transfer of the said amount to the Customer’s bank account shall be deemed as the final receipt of payment by the Customer.The Customer acknowledges and agrees that the held-back amount shall be forfeited in full or in part if the Customer fails to satisfy, close, or comply with any of the contingencies for which the amount was withheld within the timeframe specified at the date of vehicle delivery. Please note that deductions, charges, and forfeited held-back amounts are non-refundable. All held-back amounts will be released within 24 working hours of fulfilling the release conditions.`,4,49,{maxWidth:205})
   doc.text(`8. The Customer shall keep Car Swipe and the future buyer indemnified and exonerated from all losses, claims, liabilities, risks, responsibilities, and damages arising on or before the delivery of the Vehicle to Car Swipe.`,4,82,{maxWidth:205})
   doc.text(`9. The Customer understands and acknowledges that any misrepresentation by the Customer of any facts with Car Swipe shall result in Car Swipe taking appropriate action under the relevant provisions of law with the concerned statutory authorities and/or before the competent Courts/Tribunals.`,4,97,{maxWidth:205})
   doc.text(`10. In case of any difference and/or dispute between the Customer and Car Swipe, the matter shall be referred to an Arbitration Tribunal consisting of a sole arbitrator to be appointed by Car Swipe, and the award passed by the Arbitration Tribunal shall be final and binding upon both parties. The venue of Arbitration shall be Sultanpur district, Uttar Pradesh, and the language shall be English/Hindi. The courts situated in Sultanpur district, Uttar Pradesh, shall possess exclusive jurisdiction.`,4,113,{maxWidth:205})
   doc.text(`11. In case of a scrap vehicle, the Customer acknowledges and accepts that Car Swipe, to the best of its efforts, shall be competent and possess all rights to call upon the Customer for any statutory or regulatory formalities, and the Customer shall cooperate with Car Swipe for the same. The Customer acknowledges that he/she shall be responsible for collecting the chassis plate of the Vehicle from Car Swipe's regional support center as and when suggested by Car Swipe or within 45-60 days from the delivery of the vehicle, whichever is later. Car Swipe shall not be liable to provide the chassis plate in case of any failure to collect it within the specified time by the Customer, and the Customer shall be solely liable for any consequences arising therefrom.`,4,134,{maxWidth:205})
   doc.text(`12. The Customer understands and acknowledges that in case of any change/amendment in any applicable law, if required and mandated, the Customer shall comply with any such change/amendment, and Car Swipe shall not be liable for any resultant effect thereof in any nature whatsoever, including but not limited to any ownership transfer.`,4,163,{maxWidth:205})
   doc.text(`13. The Customer hereby acknowledges and affirms that the Customer shall be solely liable for any and all consequences arising from the payment made by Car Swipe into the bank account as per the Customer's instructions. The Customer shall be solely responsible for indemnifying and compensating Car Swipe in case of any claim arising due to the payment instructions provided by the Customer.`,4,180,{maxWidth:205})
   doc.text(`14. The Customer acknowledges that removing any personal belongings from the vehicle and closure of the FASTag linked account, if any, before delivering the vehicle to Car Swipe, is the sole responsibility of the Customer. Car Swipe shall not be responsible for any loss or liabilities arising in this respect after taking the physical delivery of the vehicle from the Customer.`,4,197,{maxWidth:205})
   doc.text(`15. Car Swipe will not be responsible for any charges, costs, or expenses that may be imposed on the Customer for the purchase of any additional vehicles by the RTO, including any additional registration charges on such vehicles.`,4,215,{maxWidth:205})
   doc.text(`16. Car Swipe does not accept any cash amount. Any cash paid to any employees or any third party of Car Swipe, or any cash deposit into the bank account of Car Swipe, will not be accepted. In such cases, any transaction made in cash by the seller will not be considered valid, and Car Swipe shall not be liable for any such transaction. The seller cannot claim any monetary or non-monetary loss/compensation with respect to any cash transaction made to Car Swipe or any of its employees.`,4,230,{maxWidth:205})
